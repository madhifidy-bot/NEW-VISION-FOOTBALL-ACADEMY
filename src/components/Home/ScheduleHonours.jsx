...
const schedule = [
  { date: "WED 5:00–6:00 PM", event: "Goalkeeper training", type: "All ages • Mini Pitch" },
  { date: "THU 4:00–5:30 PM", event: "Skills competition (dribbling race, shooting)", type: "U7–U12 • Garden Estate" },
  { date: "THU 5:30–6:30 PM", event: "Team bonding & life skills", type: "All ages • Classroom" },
  { date: "WED 4:00–5:00 PM", event: "Physical conditioning (agility, speed)", type: "U9–U15 • Garden Estate" }
];
